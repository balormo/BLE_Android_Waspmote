...
public class BluetoothLeService extends Service {
    ...
    private void broadcastUpdate(final String action, final BluetoothGattCharacteristic characteristic) {
        ...
        if (UUID_USER_SERVICE_1_CHAR4.equals(characteristic.getUuid())) {
        ...
        if (UUID_USER_SERVICE_1_CHAR6.equals(characteristic.getUuid())) {
            ...
            if (data != null && data.length > 0) {
                ...
                intent.putExtra(EXTRA_DATA_T, new String(data) + "\n" + stringBuilder.toString());
            }
        }*/
        sendBroadcast(intent);
    }
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic,
        ...
        // This is specific to USER_SERVICE_1 CHARACTERISTIC 4
        if (UUID_USER_SERVICE_1_CHAR4.equals(characteristic.getUuid())) {
